...
public enum GradeSystem {
    uiaa("UIAA|Germany", R.string.grade_system_uiaa, R.string.grade_system_uiaa_description,
            new String[] {"1-","1","1+","2-","2","2+","3-","3","3+","4-","4","4+","5-","5","5+","6-","6","6+","7-","7","7+","8-","8","8+","9-","9","9+","10-","10","10+","11-","11","11+","12+","12","12+","13-","13","13+","14-"}),
    ukTech("UK Tech", R.string.grade_system_uk_tech, R.string.grade_system_uk_tech_description,
    ...
    ukAdj("UK ADJ", R.string.grade_system_uk_adj, R.string.grade_system_uk_adj_description,
    ...
    fb("FB|French British", R.string.grade_system_fb, R.string.grade_system_fb_description,
    ...
    french("French", R.string.grade_system_french, R.string.grade_system_french_description,
    ...
    saxon("Saxon|Swiss", R.string.grade_system_saxon, R.string.grade_system_saxon_description,
    ...
    nordic("Nordic|Scandinavian", R.string.grade_system_nordic, R.string.grade_system_nordic_description,
            new String[] {"1","1","1","1","1","1","1/2","1/2","1/2","2","2","2","2/3","3","4a","4a/4b","4b","4c","5a","5b","5c","6a","6b","6b+","6c","6c+","7a","7a+","7a+/7b","7b","7b+","7c","7c+","7c+/8a","8a","8a+/8b","8b","8b+","8c","8c+"}),
    yds("YDS|YDS_class", R.string.grade_system_yds, R.string.grade_system_yds_description,
    ...
    vGrade("V Grade", R.string.grade_system_v_grade, R.string.grade_system_v_grade_description,
    ...
    undef("undefined", R.string.grade_system_undefined, R.string.grade_system_undefined_description, null);
    ...
    public static class GradeSystemArrayAdapter extends ArrayAdapter<GradeSystem> {
        ...
        private View getCustomView(int position, View convertView, ViewGroup parent, boolean selected) {
            ...
            textView.setText(getItem(position).buildExample());
