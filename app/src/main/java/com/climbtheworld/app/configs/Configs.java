...
public class Configs {
	...
	public Set<GeoNode.ClimbingStyle> getClimbingStyles() {
		if (!settings.contains(ConfigKey.filterStyles.storeKeyID)) {
			return new TreeSet<>(
					Arrays.asList((GeoNode.ClimbingStyle[]) ConfigKey.filterStyles.defaultVal));
		}
	...
	public Set<GeoNode.NodeTypes> getNodeTypes() {
		if (!settings.contains(ConfigKey.filterNodeTypes.storeKeyID)) {
			return new TreeSet<>(
					Arrays.asList((GeoNode.NodeTypes[]) ConfigKey.filterNodeTypes.defaultVal));
		}
	...
	public enum ConfigKey {
		...
		intercomChannel(R.string.channel, R.string.channel_description, "intercomChannel",
				"Welcome"),
		intercomAllowWiFi(R.string.walkie_talkie_allow_wifi,
				R.string.walkie_talkie_allow_wifi_description, "intercomAllowWiFi", true),
		intercomAllowBluetooth(R.string.walkie_talkie_allow_bluetooth,
				R.string.walkie_talkie_allow_bluetooth_description, "intercomAllowBluetooth",
				true),
		intercomAllowWiFiDirect(R.string.walkie_talkie_allow_wifi_direct,
				R.string.walkie_talkie_allow_wifi_description, "intercomAllowWiFiDirect", true),
		intercomAllowWiFiAware(R.string.walkie_talkie_allow_wifi_direct,
				R.string.walkie_talkie_allow_wifi_description, "intercomAllowWiFiDirect", true),
		...
		converterGradeSystem(-1, -1, "converterGradeSystem",
				UIConstants.STANDARD_SYSTEM.getMainKey()),
		...
		converterTemperatureSystem(-1, -1, "converterTemperatureSystem",
				TemperatureSystem.kelvin.name()),
		...
		keepScreenOn(R.string.keep_screen_on, R.string.keep_screen_on_description, "keepScreenOn",
				true),
		useMobileDataForMap(R.string.use_mobile_data_for_map,
				R.string.use_mobile_data_for_map_description, "useMobileDataForMap", true),
		useMobileDataForRoutes(R.string.use_mobile_data_for_routes,
				R.string.use_mobile_data_for_routes_description, "useMobileDataForRoutes", true),
		...
		ConfigKey(int stringID, int descriptionID, String storeKeyID, Object defValue, Object min,
		          Object max) {
			this(stringID, descriptionID, storeKeyID, defValue, min, max, false);
		}

		ConfigKey(int stringID, int descriptionID, String storeKeyID, Object defValue, Object min,
		          Object max, boolean isVolatile) {
